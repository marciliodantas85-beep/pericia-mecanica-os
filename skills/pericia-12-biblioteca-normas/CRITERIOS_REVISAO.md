# Critérios de Revisão - Biblioteca de Normas e Métodos

## Revisão Obrigatória

- Tipo da fonte está correto?
- URL oficial foi registrada?
- Há data de consulta e próxima verificação?
- Licença e impacto foram descritos?
